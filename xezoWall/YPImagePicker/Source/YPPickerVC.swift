...
open class YPPickerVC: YPBottomPager, YPBottomPagerDelegate {
    ...
    private var postCreateVC: PostCreationViewController?
    ...
    open override func viewDidLoad() {
        ...
        if YPConfig.screens.contains(.postCreateVC) {
            postCreateVC = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(identifier: Controllers.postCreationVC)
        }
        ...
        for screen in YPConfig.screens {
            ...
            case .postCreateVC:
                if let postCreateVC = postCreateVC {
                    vcs.append(postCreateVC)
                }
            }
        }
        controllers = vcs
    ...
    func modeFor(vc: UIViewController) -> Mode {
        ...
        case is YPVideoCaptureVC:
            return .video
        case is PostCreationViewController:
            return .postCreateVC
        default:
            return .camera
        }
